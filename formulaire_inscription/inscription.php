...
<main class="card" role="main" aria-labelledby="titre">
    ...
    <form action="#" method="post" novalidate>
      ...
      <div class="field">
        ...
        <input id="mdp" name="mdp" type="password" placeholder="Mot de passe" required autocomplete="new-password" minlength="8">
      </div>

      <div class="field">
        <label for="mdp2">Confirmer mot de passe</label>
        <input id="mdp2" name="mdp2" type="password" placeholder="Confirmer mot de passe" required autocomplete="new-password" minlength="8">
      </div>
